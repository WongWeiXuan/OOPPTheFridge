...
public class Profile3Controller {
	...
	// Event Listener on JFXButton[#button1].onAction
	@FXML
	public void goToMain(ActionEvent event) throws IOException {
		Stage stage = (Stage)((Node) event.getSource()).getScene().getWindow();
		Parent root = (Parent)FXMLLoader.load(getClass().getResource("/theFridge/view/Profile3.fxml"));
		root = FXMLLoader.load(getClass().getResource("/theFridge/view/Profile.fxml"));
		stage.setScene(new Scene(root));
 	    stage.show();
	}
	// Event Listener on JFXButton[#button2].onAction
	@FXML
	...
	// Event Listener on JFXButton[#button3].onAction
	@FXML
	public void staying(ActionEvent event) throws IOException {
		Stage stage = (Stage)((Node) event.getSource()).getScene().getWindow();
		Parent root = FXMLLoader.load(getClass().getResource("/theFridge/view/Pofile3.fxml"));
		stage.setScene(new Scene(root));
 	    stage.show();
	}
	// Event Listener on VBox[#ProfileMenu].onMouseClicked
